resource "aws_iam_role" "the-nerd-herd-role" {
...
resource "aws_iam_role_policy_attachment" "the-nerd-herd-AmazonEKSClusterPolicy" {
...
resource "aws_iam_role_policy_attachment" "the-nerd-herd-AmazonEKSVPCResourceController" {
